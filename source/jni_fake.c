...
/* Modified UTF-8 to UTF-16 code-unit length. */
...
/* Native audio properties consumed by FMOD. */
...
/* Decode String(byte[][, charset]) constructors. */
...
static void *j_CallObjectMethodA (void *e, void *r, FakeID *id, const void *a){
  /* Preserve the AudioManager property key from jvalue[0]. */
...
/* Copy an ASCII-safe modified UTF-8 region. */
...
/* Widen an ASCII region to UTF-16. */
...
static void *field_object(const FakeID *id) {
  ...
  /* AudioManager output properties consumed by FMOD. */
...
/* Opaque IDs for AndroidJavaProxy reflection. */
